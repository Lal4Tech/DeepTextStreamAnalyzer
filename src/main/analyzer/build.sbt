...
libraryDependencies ++= Seq(
  ...
  "org.apache.spark" %% "spark-mllib" % "1.2.1" % "runtime",
  "edu.stanford.nlp" % "stanford-corenlp" % "3.9.1" artifacts (Artifact("stanford-corenlp", "models"), Artifact("stanford-corenlp")),
